...
def RunZSO(func):
    ...
    np.savetxt("./ZSO_Gauss_Data/CEC2014/F" + str(FuncNum) + "_" + str(DimSize) + "D.csv", All_Trial_Best, delimiter=",")
...
if __name__ == "__main__":
    if os.path.exists('./ZSO_Gauss_Data/CEC2014') == False:
        os.makedirs('./ZSO_Gauss_Data/CEC2014')
    Dims = [50]
    for Dim in Dims:
        main(Dim)
