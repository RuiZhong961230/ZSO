...
def RunZSO(func):
    ...
    np.savetxt("./ZSO_Gauss_Data/Engineer/" + str(FuncNum) + ".csv", All_Trial_Best, delimiter=",")
...
if __name__ == "__main__":
    if os.path.exists('./ZSO_Gauss_Data/Engineer') == False:
        os.makedirs('./ZSO_Gauss_Data/Engineer')
    main()
